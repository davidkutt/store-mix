...
export const DEV_ENV = ExpoConst?.manifest?.packagerOpts?.dev || false;

const _log = (values) => DEV_ENV && reactotron.log(values);
const _warn = (values) => DEV_ENV && reactotron.warn(values);
const _error = (values) => DEV_ENV && reactotron.error(values);
