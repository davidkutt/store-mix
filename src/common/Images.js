...
const Images = {
  ...
  PlaceHolderURL:
    "https://mstore.io/wp-content/uploads/2017/07/placeholder.png",
  ...
  IconHome: require("@images/icons/icon-home.png"),
  IconCategory: require("@images/icons/icon-category.png"),
  IconUser: require("@images/icons/icon-user.png"),
  ...
  IconDropdown: require("@images/icons/down_arrow.png"),
  IconSort: require("@images/icons/sort.png"),
